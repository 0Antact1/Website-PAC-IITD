...
// const RegistrationPage = ({content}) => {
//   const location = useLocation();
//   const queryParams = new URLSearchParams(location.search);
//   const event = queryParams.get('event');

//   const eventData = content[event] || {head:"Dance", image:starb};
...
//           <h3 className="text-black text-center font-Impact text-48 mb-5">Registration for {eventData.head}</h3>
//           <form>
//             <div className="mb-3">
...
//         <img className="object-cover object-center rounded-t-xl lg:h-48 md:h-36" src={eventData.image} />
//       </div>
...
const RegistrationPage = () => {
  return (
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-no-repeat bg-cover relative items-center bg-gray-500 bg-[url('assets/img/moon-lander.png')]">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-red-400">
            <div class="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center bg-[url('assets/img/moon-lander.png')]">
                <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            </div>
